"""Audio-visual block runner with NeuroSpec trigger logging.

Presents target/masker pairs of spatialized speech videos across a 3-monitor
PsychoPy setup. A serial trigger is issued at each white-noise/crosshair
onset and at audio-only trial start; trigger times are written to CSV
alongside trial responses.
