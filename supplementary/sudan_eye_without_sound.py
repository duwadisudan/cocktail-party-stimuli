...
class AudioVisualExperiment:
    ...
    def run_control_trial(self, win1, win2, target_screen, masker_screen):
        ...
        commands = ["Move eyes left", "Move eyes right"]

# Shuffle the list
        random.shuffle(commands)

        with open('C:\\Users\\mn0mn\\Documents\\Stimuli\\eye_no_sound.csv', 'a', newline='') as file:
...
# Display the shuffled list
        ...
        #crosshair.draw()
        #win1.flip()
        core.wait(5) # as if crosshair fixation is the
        ...
        announcement = visual.TextStim(self.win3, text=f"Center", pos=(0, 0),height=0.05)
        announcement.draw() 
        self.win3.flip()
        core.wait(1)
        self.win3.flip()
