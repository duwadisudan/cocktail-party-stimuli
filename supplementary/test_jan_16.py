...
class WholeExperiment:
    ...
    def __init__(self):
        ...
        self.white_noise_path = "C:\Sudan\Stimuli\whiteNoise_stereo.wav"  # Path to white noise sound
        self.csv_path = "C:\Sudan\Stimuli\initialization_data\iniList_sudan_test_10_30_20231030_.csv"
        self.spatial_video_folder = "C:\Sudan\\Stimuli\sudan_spatial_videos_updated"
        self.screenshot_folder = "C:\Sudan\Stimuli\Screenshots_faces_full_updated"  # Path to screenshot folder
        self.response_csv_path = f"C:\Sudan\Stimuli\initialization_data\\{filename}"
    ...
    def load_transcripts(self):
        transcripts_dict = {}
        with open("C:\\Sudan\\Stimuli\\Transcripts\\english_translations_part2_copy.csv", 'r', encoding='ISO-8859-1') as csv_file:
            csv_reader = csv.DictReader(csv_file)
            for row in csv_reader:
    ...
    def load_screenshots(self):
        screenshot_folder = "C:\\Sudan\\Stimuli\\Screenshots_faces_full_updated"
    ...
    def prepare_screenshot_stimuli(self, win1, target_movie, masker_movie):
        screenshot1_path = f"C:\\Sudan\\Stimuli\\Screenshots_faces_full_updated\\{target_movie}.jpg"
        ...
        text = visual.TextStim(win1, text="Which speaker was in the video that you just attended to?", pos=(0, 0.5), height=0.05)
    ...
    def prepare_transcript_stimuli(self, win3, target_movie,masker_movie ):
        ...
        transcript_text = visual.TextStim(win3, text="What was the target speaker saying?", pos=(0, 0.5), height=0.05)
